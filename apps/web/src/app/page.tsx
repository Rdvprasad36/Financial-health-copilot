...
export default function Home() {
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-5 py-16">
      ...
      <div className="absolute -right-20 bottom-12 h-80 w-80 rounded-full bg-sky-300/25 blur-3xl" />
      <div className="relative max-w-4xl text-center space-y-8">
        <div className="mx-auto flex w-fit items-center gap-2 rounded-full border border-blue-200 bg-white/75 px-4 py-2 text-xs font-semibold text-blue-700 shadow-sm backdrop-blur">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            href="/onboarding"
            className="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-sky-500 px-7 text-sm font-semibold text-white shadow-lg shadow-blue-500/25 transition-all hover:-translate-y-0.5 hover:shadow-xl"
          >
